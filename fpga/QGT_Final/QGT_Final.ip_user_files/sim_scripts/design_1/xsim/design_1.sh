...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L xilinx_vip -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/agustin/Xilinx/Vivado/2021.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
