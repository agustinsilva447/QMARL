...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"../../../../QGT_Final.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../QGT_Final.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
       +incdir+"/home/agustin/Xilinx/Vivado/2021.2/data/xilinx_vip/include"
}
