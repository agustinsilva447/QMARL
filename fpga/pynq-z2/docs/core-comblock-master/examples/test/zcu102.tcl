...
proc create_hier_cell_PS_infrastructure { parentCell nameHier } {
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins pl_clk0] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins PS_infrastructure/M00_AXI] [get_bd_intf_pins comblock_0/AXIL]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins PS_infrastructure/M01_AXI] [get_bd_intf_pins comblock_0/AXIF]
  ...
  connect_bd_net -net comblock_0_reg0_o [get_bd_pins comblock_0/reg0_o] [get_bd_pins comblock_0/reg15_i]
  connect_bd_net -net comblock_0_reg10_o [get_bd_pins comblock_0/reg10_o] [get_bd_pins comblock_0/reg5_i]
  connect_bd_net -net comblock_0_reg11_o [get_bd_pins comblock_0/reg11_o] [get_bd_pins comblock_0/reg4_i]
  connect_bd_net -net comblock_0_reg12_o [get_bd_pins comblock_0/reg12_o] [get_bd_pins comblock_0/reg3_i]
  connect_bd_net -net comblock_0_reg13_o [get_bd_pins comblock_0/reg13_o] [get_bd_pins comblock_0/reg2_i]
  connect_bd_net -net comblock_0_reg14_o [get_bd_pins comblock_0/reg14_o] [get_bd_pins comblock_0/reg1_i]
  connect_bd_net -net comblock_0_reg15_o [get_bd_pins comblock_0/reg0_i] [get_bd_pins comblock_0/reg15_o]
  connect_bd_net -net comblock_0_reg1_o [get_bd_pins comblock_0/reg14_i] [get_bd_pins comblock_0/reg1_o]
  connect_bd_net -net comblock_0_reg2_o [get_bd_pins comblock_0/reg13_i] [get_bd_pins comblock_0/reg2_o]
  connect_bd_net -net comblock_0_reg3_o [get_bd_pins comblock_0/reg12_i] [get_bd_pins comblock_0/reg3_o]
  connect_bd_net -net comblock_0_reg4_o [get_bd_pins comblock_0/reg11_i] [get_bd_pins comblock_0/reg4_o]
  connect_bd_net -net comblock_0_reg5_o [get_bd_pins comblock_0/reg10_i] [get_bd_pins comblock_0/reg5_o]
  connect_bd_net -net comblock_0_reg6_o [get_bd_pins comblock_0/reg6_o] [get_bd_pins comblock_0/reg9_i]
  connect_bd_net -net comblock_0_reg7_o [get_bd_pins comblock_0/reg7_o] [get_bd_pins comblock_0/reg8_i]
  connect_bd_net -net comblock_0_reg8_o [get_bd_pins comblock_0/reg7_i] [get_bd_pins comblock_0/reg8_o]
  connect_bd_net -net comblock_0_reg9_o [get_bd_pins comblock_0/reg6_i] [get_bd_pins comblock_0/reg9_o]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins PS_infrastructure/S00_ARESETN] [get_bd_pins comblock_0/axif_aresetn] [get_bd_pins comblock_0/axil_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins PS_infrastructure/pl_clk0] [get_bd_pins comblock_0/axif_aclk] [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins comblock_0/ram_clk_i] [get_bd_pins fifo_loop_0/clk_i]

  # Create address segments
  create_bd_addr_seg -range 0x00040000 -offset 0x80040000 [get_bd_addr_spaces PS_infrastructure/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs comblock_0/AXIF/AXIF] SEG_comblock_0_AXIF
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces PS_infrastructure/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs comblock_0/AXIL/AXIL] SEG_comblock_0_AXIL
