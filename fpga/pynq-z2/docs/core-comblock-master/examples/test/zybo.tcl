...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins PS_infrastructure/S00_ARESETN] [get_bd_pins comblock_0/axif_aresetn] [get_bd_pins comblock_0/axil_aresetn]
