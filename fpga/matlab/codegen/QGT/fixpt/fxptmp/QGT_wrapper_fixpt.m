...
%                                                                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [p00,p01,p10,p11] = QGT_wrapper_fixpt(rotAx1,rotAy2,rotAx3,rotBx1,rotBy2,rotBx3)
    fm = get_fimath();
    ...
    [p00_out,p01_out,p10_out,p11_out] = QGT_fixpt( rotAx1_in, rotAy2_in, rotAx3_in, rotBx1_in, rotBy2_in, rotBx3_in );
    p00 = double( p00_out );
    p01 = double( p01_out );
    p10 = double( p10_out );
    p11 = double( p11_out );
